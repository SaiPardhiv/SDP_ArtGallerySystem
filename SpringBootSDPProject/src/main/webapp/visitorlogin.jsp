...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2>LOGIN</h2><BR/>
            <form action="checkvisitorlogin" method="post">
                <label for="vemail">Email:</label>
                <input type="text" id="email" name="vemail" required>
            ...
            <div class="footer-message">
                ...
                <p>Don't have an account? <a href="visitorreg" class="link-info">Register here</a></p>
                <p>Login for : <a href="artistlogin">Artist</a>/<a href="curatorlogin">Curator</a></p>
            </div>
